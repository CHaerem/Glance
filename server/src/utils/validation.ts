 ...
 */
export function validateDeviceId(deviceId: unknown): deviceId is string {
  return (
...
/**
 * Validate image data (base64 or buffer string)
 * @param imageData - Image data to validate
 * @returns True if valid (under 10MB)
 */
export function validateImageData(imageData: unknown): imageData is string {
 ...
 * @returns Sanitized input (max 1000 chars)
 */
...
/** Art generation themes for random prompts */
...
/** Art generation styles for random prompts */
 ...
 * @returns Random art generation prompt
 */
export function getRandomLuckyPrompt(): string {
